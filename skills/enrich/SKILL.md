...
```
Bash(command="KNOWLEDGE_SCRIPTS=$(ls -d ~/.claude/plugins/cache/*/knowledge/*/node_modules/@agiterra/knowledge-tools/scripts 2>/dev/null | sort -V | tail -1) && python3 $KNOWLEDGE_SCRIPTS/association-search.py --json \"$ARGUMENTS\"")
```
...
```
Bash(command="KNOWLEDGE_SCRIPTS=$(ls -d ~/.claude/plugins/cache/*/knowledge/*/node_modules/@agiterra/knowledge-tools/scripts 2>/dev/null | sort -V | tail -1) && python3 $KNOWLEDGE_SCRIPTS/sonnet-filter.py \"$ARGUMENTS\" \"<context>\"")
```
